...
for key,value in pairs({
	...
	[-1000190] = "Interface/Icons/achievement_reputation_argentchampion",
	...
	[-1000214] = _.asset("Expansion_WOTLK"),
	[-1000215] = _.asset("Expansion_WOTLK"),
	[-1000220] = "Interface/Icons/Inv_drink_10",
	...
	[-1000225] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000174] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
	...
	[-1000204] = "These rewards were made available to anyone who purchased a Dark Portal Pass for TBC Classic.\n\nThe act of adding items for real money to the In-Game Shop in Classic has widely been frowned upon.",
	...
	[-1000214] = "These rewards were made available to anyone who purchased a Northrend Heroic Upgrade for WotLK Classic. (not to be confused with the original Wrath of the Lich King Collector's Edition)",
...
for key,value in pairs({
	...
	[-1000204] = "Pass zum Dunklen Portal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000204] = "Pase para el Portal Oscuro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000204] = "Passe Porte des ténèbres",
...
for key,value in pairs({
	...
	[-1000204] = "Пропуск Темного портала",
}) do a[key] = value; end
end
