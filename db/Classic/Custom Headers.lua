...
_.HeaderConstants = {
	...
	EXPLORATION = -1000017,
	FACTIONS = -1000018,
	FEAST_OF_WINTER_VEIL_HEADER = -1000157,
	FLIGHT_PATHS = -1000019,
	FOLLOWERS = -1000020,
	HALLOWS_END_HEADER = -1000159,
	HARVEST_FESTIVAL_HEADER = -1000160,
	HOLIDAYS = -1000022,
	HONOR_TITLES = -1000121,
	LOVE_IS_IN_THE_AIR_HEADER = -1000163,
	LUNAR_FESTIVAL_HEADER = -1000164,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000166,
	NOBLEGARDEN_HEADER = -1000167,
	PROFESSIONS = -1000027,
	PVP = -1000123,
	QUESTS = -1000028,
	RARES = -1000029,
...
_.Modules.Events.SetEventInformation(479, {
	_.Modules.Events.CreateSchedule({["hour"]=0,["minute"]=0,["month"]=5,["monthDay"]=7,["weekday"]=1,["year"]=2023},{["hour"]=0,["minute"]=0,["month"]=5,["monthDay"]=14,["weekday"]=1,["year"]=2023},{["remappedID"]=374}),
...
for key,value in pairs({
	...
	[-1000116] = "Interface/Icons/INV_BannerPVP_02",
	...
	[-1000157] = _.asset("Holiday_winter_veil"),
	[-1000159] = _.asset("Holiday_hallows_end"),
	[-1000160] = _.asset("Holiday_Harvestfest"),
	[-1000163] = _.asset("Holiday_love"),
	[-1000164] = _.asset("Holiday_Lunar"),
	[-1000166] = _.asset("Holiday_Midsummer"),
	[-1000167] = _.asset("Holiday_noblegarden"),
	[-1000171] = "Interface/Icons/inv_misc_fish_06",
	[-1000178] = "Interface/Icons/inv_box_01",
	[-1000180] = "Interface/Icons/Inv_hammer_25",
	[-1000181] = "Interface/Icons/inv_stone_02",
	[-1000182] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000187] = _.asset("Promotion_Blizzcon"),
	[-1000188] = _.asset("Promotion_Collector"),
	[-1000205] = "Interface/Icons/Inv_drink_10",
	[-1000206] = "Interface/Icons/Spell_Misc_Drink",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000157] = GetSpellInfo(21953),
	[-1000159] = "Hallow's End",
	[-1000160] = "Harvest Festival",
	[-1000163] = "Love is in the Air",
	[-1000164] = "Lunar Festival",
	[-1000166] = "Midsummer Fire Festival",
	[-1000167] = "Noblegarden",
	[-1000171] = "Stranglethorn Fishing Extravaganza",
	[-1000178] = "The Ahn'Qiraj War Effort",
	[-1000180] = "The Scepter of the Shifting Sands",
	[-1000181] = "The Scourge Invasion",
	[-1000182] = "The Silithyst Must Flow",
	[-1000187] = "BlizzCon",
	[-1000188] = "Collector's Edition",
	[-1000205] = "iCoke",
	[-1000206] =  AUCTION_CATEGORY_MISCELLANEOUS,
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000146] = "Kathedrale",
	[-1000166] = "Sonnenwendfest",
	[-1000171] = "Anglerwettbewerb im Schlingendorntal",
	[-1000180] = "Das Szepter der Sandstürme",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000166] = "Festival del Fuego del Solsticio de Verano",
	[-1000171] = "Gran espectáculo de pesca de Tuercespina",
	[-1000180] = "El cetro del Mar de Dunas",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000166] = "Fête du Feu du solstice d’été",
	[-1000171] = "Concours de pêche de Strangleronce",
	[-1000178] = "Effort de guerre d’Ahn'Qiraj",
	[-1000180] = "Le Sceptre des Sables changeants",
	[-1000188] = "Edition Collector",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000166] = "Fuochi di Mezza Estate",
	[-1000171] = "Gara di Pesca a Rovotorto",
	[-1000180] = "Scettro delle Sabbie Mutevoli",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000166] = "Festival do Fogo do Solstício",
	[-1000171] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000180] = "Cetro das Areias Cambiantes",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000166] = "Огненный Солнцеворот",
	[-1000171] = "Рыбомания Тернистой долины",
	[-1000178] = "Война в Ан'Кираже",
	[-1000180] = "Скипетр Зыбучих песков",
	[-1000181] = "Вторжение Плети",
	[-1000188] = "Коллекционное издание",
}) do a[key] = value; end
end
