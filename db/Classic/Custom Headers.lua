...
_.HeaderConstants = {
	...
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	FEAST_OF_WINTER_VEIL_HEADER = -1000176,
	FLIGHT_PATHS = -1000020,
	HALLOWS_END_HEADER = -1000178,
	HARVEST_FESTIVAL_HEADER = -1000179,
	HOLIDAYS = -1000023,
	HONOR_TITLES = -1000134,
	LOVE_IS_IN_THE_AIR_HEADER = -1000182,
	LUNAR_FESTIVAL_HEADER = -1000183,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000185,
	NOBLEGARDEN_HEADER = -1000186,
	PROFESSIONS = -1000028,
	PVP = -1000136,
	QUESTS = -1000029,
	RARES = -1000030,
...
for key,value in pairs({
	...
	[-1000176] = _.asset("Holiday_winter_veil"),
	[-1000178] = _.asset("Holiday_hallows_end"),
	[-1000179] = _.asset("Holiday_Harvestfest"),
	[-1000182] = _.asset("Holiday_love"),
	[-1000183] = _.asset("Holiday_Lunar"),
	[-1000185] = _.asset("Holiday_Midsummer"),
	[-1000186] = _.asset("Holiday_noblegarden"),
	[-1000190] = "Interface/Icons/inv_misc_fish_06",
	...
	[-1000224] = "Interface/Icons/Inv_drink_10",
	[-1000225] = "Interface/Icons/Spell_Misc_Drink",
	[-1000230] = "Interface/Icons/inv_chest_leather_08",
	[-1000231] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000232] = "Interface/Icons/inv_misc_questionmark",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000176] = GetSpellInfo(21953),
	[-1000178] = "Hallow's End",
	[-1000179] = "Harvest Festival",
	[-1000182] = "Love is in the Air",
	[-1000183] = "Lunar Festival",
	[-1000185] = "Midsummer Fire Festival",
	[-1000186] = "Noblegarden",
	[-1000190] = "Stranglethorn Fishing Extravaganza",
...
for key,value in pairs({
	...
	[-1000232] = "This Category contains Things that probably exist in the game but no known source.",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000185] = "Sonnenwendfest",
	[-1000190] = "Anglerwettbewerb im Schlingendorntal",
...
for key,value in pairs({
	...
	[-1000185] = "Festival del Fuego del Solsticio de Verano",
	[-1000190] = "Gran espectáculo de pesca de Tuercespina",
...
for key,value in pairs({
	...
	[-1000185] = "Fête du Feu du solstice d’été",
	[-1000190] = "Concours de pêche de Strangleronce",
...
for key,value in pairs({
	...
	[-1000185] = "Fuochi di Mezza Estate",
	[-1000190] = "Gara di Pesca a Rovotorto",
...
for key,value in pairs({
	...
	[-1000185] = "Festival do Fogo do Solstício",
	[-1000190] = "Festerê de Pesca da Selva do Espinhaço",
