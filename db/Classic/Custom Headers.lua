...
for key,value in pairs({
	...
	[-1000121] = "Interface/Icons/INV_BannerPVP_02",
	...
	[-1000176] = "Interface/Icons/inv_misc_fish_06",
	[-1000183] = "Interface/Icons/inv_box_01",
	[-1000185] = "Interface/Icons/Inv_hammer_25",
	[-1000186] = "Interface/Icons/inv_stone_02",
	[-1000187] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000192] = _.asset("Promotion_Blizzcon"),
	[-1000193] = _.asset("Promotion_Collector"),
	[-1000210] = "Interface/Icons/Inv_drink_10",
	[-1000211] = "Interface/Icons/Spell_Misc_Drink",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000160] = "Children's Week",
	[-1000162] = GetSpellInfo(21953),
	[-1000164] = "Hallow's End",
	[-1000165] = "Harvest Festival",
	[-1000168] = "Love is in the Air",
	[-1000169] = "Lunar Festival",
	[-1000171] = "Midsummer Fire Festival",
	[-1000172] = "Noblegarden",
	[-1000176] = "Stranglethorn Fishing Extravaganza",
	[-1000183] = "The Ahn'Qiraj War Effort",
	[-1000185] = "The Scepter of the Shifting Sands",
	[-1000186] = "The Scourge Invasion",
	[-1000187] = "The Silithyst Must Flow",
	[-1000192] = "BlizzCon",
	[-1000193] = "Collector's Edition",
	[-1000210] = "iCoke",
	[-1000211] =  AUCTION_CATEGORY_MISCELLANEOUS,
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000176] = "Anglerwettbewerb im Schlingendorntal",
	[-1000185] = "Das Szepter der Sandstürme",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000176] = "Gran espectáculo de pesca de Tuercespina",
	[-1000185] = "El cetro del Mar de Dunas",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000176] = "Concours de pêche de Strangleronce",
	[-1000183] = "Effort de guerre d’Ahn'Qiraj",
	[-1000185] = "Le Sceptre des Sables changeants",
	[-1000193] = "Edition Collector",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000176] = "Gara di Pesca a Rovotorto",
	[-1000185] = "Scettro delle Sabbie Mutevoli",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000176] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000185] = "Cetro das Areias Cambiantes",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000176] = "Рыбомания Тернистой долины",
	[-1000183] = "Война в Ан'Кираже",
	[-1000185] = "Скипетр Зыбучих песков",
	[-1000186] = "Вторжение Плети",
	[-1000193] = "Коллекционное издание",
}) do a[key] = value; end
end
