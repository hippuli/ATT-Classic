...
for key,value in pairs({
	...
	[-1000188] = "Interface/Icons/inv_box_01",
	[-1000189] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000190] = "Interface/Icons/Inv_hammer_25",
	[-1000191] = "Interface/Icons/inv_stone_02",
	[-1000192] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000197] = _.asset("Promotion_Blizzcon"),
	[-1000198] = _.asset("Promotion_Collector"),
	[-1000199] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000207] = _.asset("Expansion_TBC"),
	[-1000215] = "Interface/Icons/Inv_drink_10",
	[-1000216] = "Interface/Icons/Spell_Misc_Drink",
	[-1000217] = _.asset("achievement_reputation_08"),
	[-1000219] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000220] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000188] = "The Ahn'Qiraj War Effort",
	[-1000189] = "The Opening of the Dark Portal",
	[-1000190] = "The Scepter of the Shifting Sands",
	[-1000191] = "The Scourge Invasion",
	[-1000192] = "The Silithyst Must Flow",
	[-1000197] = "BlizzCon",
	[-1000198] = "Collector's Edition",
	[-1000199] = "Dark Portal Pass",
	[-1000207] = "TBC Classic Deluxe Edition",
	[-1000215] = "iCoke",
	[-1000216] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000217] = REFER_A_FRIEND,
	[-1000219] = "Spirit of Competition",
	[-1000220] = BATTLE_PET_SOURCE_9,
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000189] = "Die Öffnung des Dunklen Portals",
	[-1000190] = "Das Szepter der Sandstürme",
	[-1000199] = "Pass zum Dunklen Portal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000189] = "La apertura del Portal Oscuro",
	[-1000190] = "El cetro del Mar de Dunas",
	[-1000199] = "Pase para el Portal Oscuro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000188] = "Effort de guerre d’Ahn'Qiraj",
	[-1000189] = "L'ouverture de la Porte des ténèbres",
	[-1000190] = "Le Sceptre des Sables changeants",
	[-1000198] = "Edition Collector",
	[-1000199] = "Passe Porte des ténèbres",
	[-1000207] = "Édition BC Classic Deluxe",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000189] = "L'apertura del Portale Oscuro",
	[-1000190] = "Scettro delle Sabbie Mutevoli",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000189] = "A abertura do Portal Negro",
	[-1000190] = "Cetro das Areias Cambiantes",
	[-1000199] = "Passe do Portal Negro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000188] = "Война в Ан'Кираже",
	[-1000189] = "Открытие Темного портала",
	[-1000190] = "Скипетр Зыбучих песков",
	[-1000191] = "Вторжение Плети",
	[-1000198] = "Коллекционное издание",
	[-1000199] = "Пропуск Темного портала",
}) do a[key] = value; end
end
