...
for key,value in pairs({
	...
	[-1000107] = _.asset("achievement_featsofstrength_gladiator_01"),
	[-1000108] = _.asset("achievement_featsofstrength_gladiator_02"),
	[-1000109] = _.asset("achievement_featsofstrength_gladiator_03"),
	[-1000110] = _.asset("achievement_featsofstrength_gladiator_04"),
	...
	[-1000122] = "Interface/Icons/inv_jewelry_amulet_03",
...
for key,value in pairs({
	...
	[-1000099] = "Patch 2.x.x",
	[-1000107] = "Gladiator: Season 1",
	[-1000108] = "Merciless Gladiator: Season 2",
	[-1000109] = "Vengeful Gladiator: Season 3",
	[-1000110] = "Brutal Gladiator: Season 4",
...
for key,value in pairs({
	...
	[-1000108] = "Erbarmungsloser Gladiator: Season 2",
	[-1000109] = "Rachsüchtiger Gladiator: Season 3",
	[-1000110] = "Brutaler Gladiator: Season 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000107] = "Gladiador: Season 1",
	[-1000108] = "Gladiador despiadado: Season 2",
	[-1000109] = "Gladiador vengativo: Season 3",
	[-1000110] = "Gladiador brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000107] = "Gladiateur: Saison 1",
	[-1000108] = "Gladiateur impitoyable: Saison 2",
	[-1000109] = "Gladiateur vengeur: Saison 3",
	[-1000110] = "Gladiateur brutal: Saison 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000107] = "Gladiatore: Season 1",
	[-1000108] = "Gladiatore Spietato: Season 2",
	[-1000109] = "Gladiatore Vendicativo: Season 3",
	[-1000110] = "Gladiatore Brutale: Season 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000107] = "검투사: Season 1",
	[-1000108] = "무자비한 검투사: Season 2",
	[-1000109] = "복수심에 불타는 검투사: Season 3",
	[-1000110] = "야만적인 검투사: Season 4",
	[-1000132] = "4인 기사단",
	[-1000167] = "한여름 불꽃축제",
	[-1000170] = "해적의 날",
...
for key,value in pairs({
	[-1000107] = "Gladiador: Season 1",
	[-1000108] = "Gladiador Impiedoso: Season 2",
	[-1000109] = "Gladiador Vingativo: Season 3",
	[-1000110] = "Gladiador Brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000107] = "Гладиатор: Сезон 1",
	[-1000108] = "Безжалостный гладиатор: Сезон 2",
	[-1000109] = "Мстительный гладиатор: Сезон 3",
	[-1000110] = "Жестокий гладиатор: Сезон 4",
