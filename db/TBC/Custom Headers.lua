...
for key,value in pairs({
	...
	[-1000116] = "237019",
	[-1000118] = "237018",
	[-1000120] = _.asset("achievement_featsofstrength_gladiator_01"),
	[-1000121] = _.asset("achievement_featsofstrength_gladiator_02"),
	[-1000122] = _.asset("achievement_featsofstrength_gladiator_03"),
	[-1000123] = _.asset("achievement_featsofstrength_gladiator_04"),
	...
	[-1000227] = _.asset("achievement_reputation_08"),
	[-1000229] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000230] = "Interface/Icons/inv_misc_ticket_tarot_stack_01",
	[-1000232] = "Interface/Icons/inv_chest_leather_08",
	[-1000233] = "Interface/Icons/inv_mace_1h_bastionquest_b_02",
	[-1000234] = "Interface/Icons/inv_misc_questionmark",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000120] = "Gladiator: Season 1",
	[-1000121] = "Merciless Gladiator: Season 2",
	[-1000122] = "Vengeful Gladiator: Season 3",
	[-1000123] = "Brutal Gladiator: Season 4",
...
for key,value in pairs({
	...
	[-1000234] = "This Category contains Things that probably exist in the game but no known source.",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000121] = "Erbarmungsloser Gladiator: Season 2",
	[-1000122] = "Rachsüchtiger Gladiator: Season 3",
	[-1000123] = "Brutaler Gladiator: Season 4",
...
for key,value in pairs({
	...
	[-1000120] = "Gladiador: Season 1",
	[-1000121] = "Gladiador despiadado: Season 2",
	[-1000122] = "Gladiador vengativo: Season 3",
	[-1000123] = "Gladiador brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000120] = "Gladiateur: Saison 1",
	[-1000121] = "Gladiateur impitoyable: Saison 2",
	[-1000122] = "Gladiateur vengeur: Saison 3",
	[-1000123] = "Gladiateur brutal: Saison 4",
...
a = L.HEADER_NAMES;
for key,value in pairs({
	[-1000120] = "Gladiatore: Season 1",
	[-1000121] = "Gladiatore Spietato: Season 2",
	[-1000122] = "Gladiatore Vendicativo: Season 3",
	[-1000123] = "Gladiatore Brutale: Season 4",
...
for key,value in pairs({
	[-1000014] = "악마 훈련사",
	[-1000038] = "무기 전문가",
	[-1000120] = "검투사: Season 1",
	[-1000121] = "무자비한 검투사: Season 2",
	[-1000122] = "복수심에 불타는 검투사: Season 3",
	[-1000123] = "야만적인 검투사: Season 4",
	[-1000145] = "4인 기사단",
	[-1000170] = "다크문 유랑단",
	[-1000186] = "한여름 불꽃축제",
	[-1000189] = "해적의 날",
...
for key,value in pairs({
	...
	[-1000120] = "Gladiador: Season 1",
	[-1000121] = "Gladiador Impiedoso: Season 2",
	[-1000122] = "Gladiador Vingativo: Season 3",
	[-1000123] = "Gladiador Brutal: Season 4",
...
for key,value in pairs({
	...
	[-1000120] = "Гладиатор: Сезон 1",
	[-1000121] = "Безжалостный гладиатор: Сезон 2",
	[-1000122] = "Мстительный гладиатор: Сезон 3",
	[-1000123] = "Жестокий гладиатор: Сезон 4",
