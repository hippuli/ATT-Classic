...
_.HeaderConstants = {
	...
	DAY_OF_THE_DEAD_HEADER = -1000158,
	DISCOVERY = -1000014,
	DROPS = -1000015,
	EXPLORATION = -1000017,
	FACTIONS = -1000018,
	FEAST_OF_WINTER_VEIL_HEADER = -1000159,
	FLIGHT_PATHS = -1000019,
	FOLLOWERS = -1000020,
	HALLOWS_END_HEADER = -1000161,
	HARVEST_FESTIVAL_HEADER = -1000162,
	HOLIDAYS = -1000022,
	HONOR_TITLES = -1000121,
	IN_GAME_SHOP = -1000082,
	LOVE_IS_IN_THE_AIR_HEADER = -1000165,
	LUNAR_FESTIVAL_HEADER = -1000166,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000168,
	NOBLEGARDEN_HEADER = -1000169,
	PILGRIMS_BOUNTY_HEADER = -1000170,
	PIRATES_DAY_HEADER = -1000171,
	PROFESSIONS = -1000027,
	PVP = -1000123,
...
for key,value in pairs({
	...
	[-1000157] = _.asset("Event_dmf"),
	[-1000158] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000159] = _.asset("Holiday_winter_veil"),
	[-1000161] = _.asset("Holiday_hallows_end"),
	[-1000162] = _.asset("Holiday_Harvestfest"),
	[-1000164] = "Interface/Icons/inv_fishingpole_03",
	[-1000165] = _.asset("Holiday_love"),
	[-1000166] = _.asset("Holiday_Lunar"),
	[-1000168] = _.asset("Holiday_Midsummer"),
	[-1000169] = _.asset("Holiday_noblegarden"),
	[-1000170] = _.asset("Holiday_Pilgrim"),
	[-1000171] = _.asset("Holiday_Pirate"),
	[-1000173] = "Interface/Icons/inv_misc_fish_06",
	...
	[-1000193] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000194] = _.asset("Expansion_CATA"),
	[-1000195] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000196] = "Interface/Icons/inv_box_01",
	[-1000197] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000198] = "Interface/Icons/Inv_hammer_25",
	[-1000199] = "Interface/Icons/inv_stone_02",
	[-1000200] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000201] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000205] = _.asset("Promotion_Blizzcon"),
	[-1000206] = _.asset("Promotion_Collector"),
	[-1000207] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000208] = "Interface/Icons/DiabloAnniversary_HoradricCube",
	[-1000212] = "Interface/Icons/Inv_sigil_thorim",
	[-1000215] = _.asset("Expansion_TBC"),
	[-1000217] = _.asset("Expansion_WOTLK"),
	[-1000218] = _.asset("Expansion_WOTLK"),
	[-1000223] = "Interface/Icons/Inv_drink_10",
...
for key,value in pairs({
	...
	[-1000157] = "Darkmoon Faire",
	[-1000158] = "Day of the Dead",
	[-1000159] = GetSpellInfo(21953),
	[-1000161] = select(1,GetCategoryInfo(158)),
	[-1000162] = "Harvest Festival",
	[-1000164] = "Kalu'ak Fishing Derby",
	[-1000165] = select(1,GetCategoryInfo(187)),
	[-1000166] = select(1,GetCategoryInfo(160)),
	[-1000168] = "Midsummer Fire Festival",
	[-1000169] = select(1,GetCategoryInfo(159)),
	[-1000170] = select(1,GetCategoryInfo(14981)),
	[-1000171] = "Pirates' Day",
	[-1000173] = "Stranglethorn Fishing Extravaganza",
	[-1000177] = "WoW's Anniversary",
	[-1000178] = select(2,GetAchievementInfo(2398)),
	[-1000179] = select(2,GetAchievementInfo(4400)),
	[-1000180] = select(2,GetAchievementInfo(5512)),
	[-1000181] = select(2,GetAchievementInfo(5863)),
	[-1000182] = select(2,GetAchievementInfo(6131)),
	[-1000193] = select(1,GetCategoryInfo(14941)),
	[-1000194] = "Elemental Unrest",
	[-1000195] = select(2, GetAchievementInfo(4786)),
	[-1000196] = "The Ahn'Qiraj War Effort",
	[-1000197] = "The Opening of the Dark Portal",
	[-1000198] = "The Scepter of the Shifting Sands",
	[-1000199] = "The Scourge Invasion",
	[-1000200] = "The Silithyst Must Flow",
	[-1000201] = select(2, GetAchievementInfo(4790)),
	[-1000205] = "BlizzCon",
	[-1000206] = "Collector's Edition",
	[-1000207] = "Dark Portal Pass",
	[-1000208] = "Diablo III",
	[-1000212] = "Starcraft II: Wings of Liberty",
	[-1000215] = "TBC Classic Deluxe Edition",
	[-1000217] = "WotLK Classic Northrend Heroic Upgrade",
	[-1000218] = "WotLK Classic Northrend Epic Upgrade",
	[-1000223] = "iCoke",
	[-1000224] =  AUCTION_CATEGORY_MISCELLANEOUS,
	[-1000225] = REFER_A_FRIEND,
	[-1000226] = SCROLL_OF_RESURRECTION,
	[-1000227] = "Spirit of Competition",
...
for key,value in pairs({
	...
	[-1000177] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
	[-1000194] = "The Elemental Unrest was a world event that heralded the Cataclysm. The event culminated in elementals attacking Stormwind, Orgrimmar, Ironforge, and Thunder Bluff. Players defeating these elementals and freeing trapped citizens within their entire city were granted access to two special boss encounters.",
	[-1000195] = "Operation: Gnomeregan was the name of Gelbin Mekkatorque's plan for the retaking of the surface of Gnomeregan. Only Alliance players between level 75 and 80 were able to serve during the operation, but lower level players helped by motivating other gnomes or by turning in items.",
	...
	[-1000218] = "These rewards were made available to anyone who purchased a Northrend Heroic Upgrade for WotLK Classic. (not to be confused with the original Wrath of the Lich King Collector's Edition)",
...
for key,value in pairs({
	...
	[-1000158] = "Tag der Toten",
	[-1000164] = "Angelwettstreit der Kalu'ak",
	[-1000168] = "Sonnenwendfest",
	[-1000171] = "Piratentag",
	[-1000173] = "Anglerwettbewerb im Schlingendorntal",
	[-1000197] = "Die Öffnung des Dunklen Portals",
	[-1000198] = "Das Szepter der Sandstürme",
	[-1000207] = "Pass zum Dunklen Portal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000158] = "Festividad de los Muertos",
	[-1000164] = "Competición de pesca Kalu'ak",
	[-1000168] = "Festival del Fuego del Solsticio de Verano",
	[-1000171] = "Día de los Piratas",
	[-1000173] = "Gran espectáculo de pesca de Tuercespina",
	[-1000197] = "La apertura del Portal Oscuro",
	[-1000198] = "El cetro del Mar de Dunas",
	[-1000207] = "Pase para el Portal Oscuro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000158] = "Jour des morts",
	[-1000164] = "Le tournoi de pêche kalu'ak",
	[-1000168] = "Fête du Feu du solstice d’été",
	[-1000171] = "Jour des pirates",
	[-1000173] = "Concours de pêche de Strangleronce",
	[-1000196] = "Effort de guerre d’Ahn'Qiraj",
	[-1000197] = "L'ouverture de la Porte des ténèbres",
	[-1000198] = "Le Sceptre des Sables changeants",
	[-1000206] = "Edition Collector",
	[-1000207] = "Passe Porte des ténèbres",
	[-1000215] = "Édition BC Classic Deluxe",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000158] = "Giorno dei Morti",
	[-1000164] = "La gara di pesca dei Kalu'ak",
	[-1000168] = "Fuochi di Mezza Estate",
	[-1000171] = "Giorno dei Pirati",
	[-1000173] = "Gara di Pesca a Rovotorto",
	[-1000197] = "L'apertura del Portale Oscuro",
	[-1000198] = "Scettro delle Sabbie Mutevoli",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000158] = "Dia dos Mortos",
	[-1000164] = "Campeonato de Pesca dos Kalu'ak",
	[-1000168] = "Festival do Fogo do Solstício",
	[-1000171] = "Dia dos Piratas",
	[-1000173] = "Festerê de Pesca da Selva do Espinhaço",
	[-1000197] = "A abertura do Portal Negro",
	[-1000198] = "Cetro das Areias Cambiantes",
	[-1000207] = "Passe do Portal Negro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000158] = "День мертвых",
	[-1000164] = "Калуакское рыбоборье",
	[-1000168] = "Огненный Солнцеворот",
	[-1000171] = "День пирата",
	[-1000173] = "Рыбомания Тернистой долины",
	[-1000194] = "Буйство элементалей",
	[-1000196] = "Война в Ан'Кираже",
	[-1000197] = "Открытие Темного портала",
	[-1000198] = "Скипетр Зыбучих песков",
	[-1000199] = "Вторжение Плети",
	[-1000206] = "Коллекционное издание",
	[-1000207] = "Пропуск Темного портала",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000208] = "暗黑破坏神III",
	[-1000212] = "星际争霸II：自由之翼",
	[-1000215] = "燃烧的远征经典怀旧服典藏包",
	[-1000217] = "巫妖王之怒经典怀旧服诺森德英雄礼包",
	[-1000218] = "巫妖王之怒经典怀旧服诺森德史诗礼包",
	[-1000223] = "可口可乐活动",
}) do a[key] = value; end
end
