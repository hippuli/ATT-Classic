...
_.HeaderConstants = {
	...
	DARKMOON_FAIRE_HEADER = -1000155,
	DAY_OF_THE_DEAD_HEADER = -1000156,
	...
	PILGRIMS_BOUNTY_HEADER = -1000168,
	PIRATES_DAY_HEADER = -1000169,
};
...
for key,value in pairs({
	...
	[-1000155] = _.asset("Event_dmf"),
	[-1000156] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000157] = _.asset("Holiday_winter_veil"),
	[-1000159] = _.asset("Holiday_hallows_end"),
	[-1000160] = _.asset("Holiday_Harvestfest"),
	[-1000162] = "Interface/Icons/inv_fishingpole_03",
	...
	[-1000168] = _.asset("Holiday_Pilgrim"),
	[-1000169] = _.asset("Holiday_Pirate"),
	...
	[-1000191] = "Interface/Icons/achievement_reputation_argentchampion",
	...
	[-1000221] = "Interface/Icons/Inv_drink_10",
...
for key,value in pairs({
	...
	[-1000155] = "Darkmoon Faire",
	[-1000156] = "Day of the Dead",
	[-1000157] = GetSpellInfo(21953),
	[-1000159] = select(1,GetCategoryInfo(158)),
	[-1000160] = "Harvest Festival",
	[-1000162] = "Kalu'ak Fishing Derby",
	[-1000163] = select(1,GetCategoryInfo(187)),
	[-1000164] = select(1,GetCategoryInfo(160)),
	[-1000166] = "Midsummer Fire Festival",
	[-1000167] = select(1,GetCategoryInfo(159)),
	[-1000168] = select(1,GetCategoryInfo(14981)),
	[-1000169] = "Pirates' Day",
	[-1000171] = "Stranglethorn Fishing Extravaganza",
	[-1000175] = "WoW's Anniversary",
	...
	[-1000191] = select(1,GetCategoryInfo(14941)),
...
for key,value in pairs({
	...
	[-1000175] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
	...
	[-1000205] = "These rewards were made available to anyone who purchased a Dark Portal Pass for TBC Classic.\n\nThe act of adding items for real money to the In-Game Shop in Classic has widely been frowned upon.",
...
for key,value in pairs({
	...
	[-1000156] = "Tag der Toten",
	[-1000162] = "Angelwettstreit der Kalu'ak",
	...
	[-1000205] = "Pass zum Dunklen Portal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000156] = "Jour des morts",
	[-1000162] = "Le tournoi de pêche kalu'ak",
	[-1000166] = "Fête du Feu du solstice d’été",
	[-1000169] = "Jour des pirates",
	...
	[-1000205] = "Passe Porte des ténèbres",
...
for key,value in pairs({
	...
	[-1000156] = "Giorno dei Morti",
	[-1000162] = "La gara di pesca dei Kalu'ak",
	[-1000166] = "Fuochi di Mezza Estate",
	[-1000169] = "Giorno dei Pirati",
...
for key,value in pairs({
	...
	[-1000156] = "День мертвых",
	[-1000162] = "Калуакское рыбоборье",
	...
	[-1000205] = "Пропуск Темного портала",
}) do a[key] = value; end
end
