...
for key,value in pairs({
	...
	[-1000211] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000212] = _.asset("Expansion_CATA"),
	[-1000213] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	[-1000214] = "Interface/Icons/inv_box_01",
	[-1000215] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
	[-1000216] = "Interface/Icons/Inv_hammer_25",
	[-1000217] = "Interface/Icons/inv_stone_02",
	[-1000218] = "Interface/Icons/spell_holiday_tow_spicecloud",
	[-1000219] = "Interface/Icons/inv_misc_tournaments_banner_troll",
	[-1000223] = _.asset("Promotion_Blizzcon"),
	[-1000224] = _.asset("Promotion_Collector"),
	[-1000225] = "Interface/Icons/achievement_dungeon_outland_dungeonmaster",
...
for key,value in pairs({
	...
	[-1000195] = "WoW's Anniversary",
	[-1000196] = select(2,GetAchievementInfo(2398)),
	[-1000197] = select(2,GetAchievementInfo(4400)),
	[-1000198] = select(2,GetAchievementInfo(5512)),
	[-1000199] = select(2,GetAchievementInfo(5863)),
	[-1000200] = select(2,GetAchievementInfo(6131)),
	[-1000211] = select(1,GetCategoryInfo(14941)),
	[-1000212] = "Elemental Unrest",
	[-1000213] = select(2, GetAchievementInfo(4786)),
	[-1000214] = "The Ahn'Qiraj War Effort",
	[-1000215] = "The Opening of the Dark Portal",
	[-1000216] = "The Scepter of the Shifting Sands",
	[-1000217] = "The Scourge Invasion",
	[-1000218] = "The Silithyst Must Flow",
	[-1000219] = select(2, GetAchievementInfo(4790)),
	[-1000223] = "BlizzCon",
	[-1000224] = "Collector's Edition",
	[-1000225] = "Dark Portal Pass",
	[-1000226] = "Diablo III",
	[-1000230] = "Starcraft II: Wings of Liberty",
	[-1000233] = "TBC Classic Deluxe Edition",
	[-1000235] = "WotLK Classic Northrend Heroic Upgrade",
...
for key,value in pairs({
	...
	[-1000215] = "Die Öffnung des Dunklen Portals",
	[-1000216] = "Das Szepter der Sandstürme",
	[-1000225] = "Pass zum Dunklen Portal",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000215] = "La apertura del Portal Oscuro",
	[-1000216] = "El cetro del Mar de Dunas",
	[-1000225] = "Pase para el Portal Oscuro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000214] = "Effort de guerre d’Ahn'Qiraj",
	[-1000215] = "L'ouverture de la Porte des ténèbres",
	[-1000216] = "Le Sceptre des Sables changeants",
	[-1000224] = "Edition Collector",
	[-1000225] = "Passe Porte des ténèbres",
...
for key,value in pairs({
	...
	[-1000215] = "L'apertura del Portale Oscuro",
	[-1000216] = "Scettro delle Sabbie Mutevoli",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000215] = "A abertura do Portal Negro",
	[-1000216] = "Cetro das Areias Cambiantes",
	[-1000225] = "Passe do Portal Negro",
}) do a[key] = value; end
end
...
for key,value in pairs({
	...
	[-1000212] = "Буйство элементалей",
	[-1000214] = "Война в Ан'Кираже",
	[-1000215] = "Открытие Темного портала",
	[-1000216] = "Скипетр Зыбучих песков",
	[-1000217] = "Вторжение Плети",
	[-1000224] = "Коллекционное издание",
	[-1000225] = "Пропуск Темного портала",
