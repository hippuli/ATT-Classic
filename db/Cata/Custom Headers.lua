...
_.HeaderConstants = {
	...
	DAY_OF_THE_DEAD_HEADER = -1000167,
	DISCOVERY = -1000015,
	DROPS = -1000016,
	EXPLORATION = -1000018,
	FACTIONS = -1000019,
	...
	LOVE_IS_IN_THE_AIR_HEADER = -1000174,
	LUNAR_FESTIVAL_HEADER = -1000175,
	MIDSUMMER_FIRE_FESTIVAL_HEADER = -1000177,
	NOBLEGARDEN_HEADER = -1000178,
	PILGRIMS_BOUNTY_HEADER = -1000179,
	PIRATES_DAY_HEADER = -1000180,
	PROFESSIONS = -1000028,
	PVP = -1000132,
...
for key,value in pairs({
	...
	[-1000167] = _.asset("Holiday_Day_of_the_Dead"),
	[-1000168] = _.asset("Holiday_winter_veil"),
	[-1000170] = _.asset("Holiday_hallows_end"),
	[-1000171] = _.asset("Holiday_Harvestfest"),
	[-1000173] = "Interface/Icons/inv_fishingpole_03",
	[-1000174] = _.asset("Holiday_love"),
	[-1000175] = _.asset("Holiday_Lunar"),
	[-1000177] = _.asset("Holiday_Midsummer"),
	[-1000178] = _.asset("Holiday_noblegarden"),
	[-1000179] = _.asset("Holiday_Pilgrim"),
	[-1000180] = _.asset("Holiday_Pirate"),
	[-1000182] = "Interface/Icons/inv_misc_fish_06",
	...
	[-1000202] = "Interface/Icons/achievement_reputation_argentchampion",
	[-1000203] = _.asset("Expansion_CATA"),
	[-1000204] = "Interface/Icons/inv_misc_tournaments_symbol_gnome",
	...
	[-1000234] = "Interface/Icons/achievement_reputation_08",
	[-1000235] = _.asset("Promotion_Scroll_of_Rez"),
	[-1000236] = "Interface/Icons/inv_jewelry_amulet_03",
	[-1000237] = "Interface/Icons/ACHIEVEMENT_GUILDPERK_LADYLUCK",
}) do a[key] = value; end
...
for key,value in pairs({
	...
	[-1000167] = "Day of the Dead",
	[-1000168] = GetSpellInfo(21953),
	[-1000170] = select(1,GetCategoryInfo(158)),
	[-1000171] = "Harvest Festival",
	[-1000173] = "Kalu'ak Fishing Derby",
	[-1000174] = select(1,GetCategoryInfo(187)),
	[-1000175] = select(1,GetCategoryInfo(160)),
	[-1000177] = "Midsummer Fire Festival",
	[-1000178] = select(1,GetCategoryInfo(159)),
	[-1000179] = select(1,GetCategoryInfo(14981)),
	[-1000180] = "Pirates' Day",
	[-1000182] = "Stranglethorn Fishing Extravaganza",
	[-1000186] = "WoW's Anniversary",
	[-1000187] = select(2,GetAchievementInfo(2398)),
	[-1000188] = select(2,GetAchievementInfo(4400)),
	[-1000189] = select(2,GetAchievementInfo(5512)),
	[-1000190] = select(2,GetAchievementInfo(5863)),
	[-1000191] = select(2,GetAchievementInfo(6131)),
	[-1000202] = select(1,GetCategoryInfo(14941)),
	[-1000203] = "Elemental Unrest",
	[-1000204] = select(2, GetAchievementInfo(4786)),
...
for key,value in pairs({
	...
	[-1000186] = "This is a yearly recurring event that occurs between the beginning of November and the end of the year.",
	[-1000203] = "The Elemental Unrest was a world event that heralded the Cataclysm. The event culminated in elementals attacking Stormwind, Orgrimmar, Ironforge, and Thunder Bluff. Players defeating these elementals and freeing trapped citizens within their entire city were granted access to two special boss encounters.",
	[-1000204] = "Operation: Gnomeregan was the name of Gelbin Mekkatorque's plan for the retaking of the surface of Gnomeregan. Only Alliance players between level 75 and 80 were able to serve during the operation, but lower level players helped by motivating other gnomes or by turning in items.",
	...
	[-1000235] = "The following item sets were implemented as boosted character rewards for recipients of the Scroll of Resurrection.\n\nThey were later added to vendors in Mount Hyjal and Vash'jir once the Scroll of Resurrection Service was retired.",
...
for key,value in pairs({
	...
	[-1000167] = "Tag der Toten",
	[-1000173] = "Angelwettstreit der Kalu'ak",
	[-1000177] = "Sonnenwendfest",
	[-1000180] = "Piratentag",
	[-1000182] = "Anglerwettbewerb im Schlingendorntal",
...
for key,value in pairs({
	...
	[-1000167] = "Festividad de los Muertos",
	[-1000173] = "Competición de pesca Kalu'ak",
	[-1000177] = "Festival del Fuego del Solsticio de Verano",
	[-1000180] = "Día de los Piratas",
	[-1000182] = "Gran espectáculo de pesca de Tuercespina",
...
for key,value in pairs({
	...
	[-1000167] = "Jour des morts",
	[-1000173] = "Le tournoi de pêche kalu'ak",
	[-1000177] = "Fête du Feu du solstice d’été",
	[-1000180] = "Jour des pirates",
	[-1000182] = "Concours de pêche de Strangleronce",
...
for key,value in pairs({
	...
	[-1000167] = "Giorno dei Morti",
	[-1000173] = "La gara di pesca dei Kalu'ak",
	[-1000177] = "Fuochi di Mezza Estate",
	[-1000180] = "Giorno dei Pirati",
	[-1000182] = "Gara di Pesca a Rovotorto",
...
for key,value in pairs({
	...
	[-1000167] = "Dia dos Mortos",
	[-1000173] = "Campeonato de Pesca dos Kalu'ak",
	[-1000177] = "Festival do Fogo do Solstício",
	[-1000180] = "Dia dos Piratas",
	[-1000182] = "Festerê de Pesca da Selva do Espinhaço",
...
for key,value in pairs({
	...
	[-1000167] = "День мертвых",
	[-1000173] = "Калуакское рыбоборье",
	[-1000177] = "Огненный Солнцеворот",
	[-1000180] = "День пирата",
	[-1000182] = "Рыбомания Тернистой долины",
	[-1000203] = "Буйство элементалей",
